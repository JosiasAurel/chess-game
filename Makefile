default:
	clang++ main.cpp  -g ./src/piece/*.cpp ./src/board/*.cpp -I./src -I./src/piece/*.cpp -I./src/board/*.cpp -std=c++20 -I./include -L./lib -Wall -Wextra -Wpedantic -lraylib -lGL -lm -lpthread -ldl -lrt -lX11 -o chess
