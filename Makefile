...
mac:
	clang++ main.cpp ./src/piece/*.cpp ./src/board/*.cpp ./src/chess/*.cpp -I./src -I./src/piece/*.cpp -I./src/board/*.cpp -I./src/chess/*.cpp -std=c++20 -Wall -Wextra -Wpedantic -I/opt/homebrew/Cellar/raylib/4.5.0/include -L/opt/homebrew/Cellar/raylib/4.5.0/lib -lraylib -lraylib -o chess
